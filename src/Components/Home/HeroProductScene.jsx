...
const SHOWCASE = [
    { index: 1, name: 'PeopleHub', tag: 'HCM & Payroll', logoBg: '#ffffff' },
    { index: 2, name: 'ProcessHub', tag: 'Operations Suite', logoBg: '#ffffff' },
    { index: 3, name: 'CommerceHub', tag: 'Unified Commerce', logoBg: '#041018' },
    { index: 0, name: 'SAP B1 UI', tag: 'Enterprise ERP', logoBg: '#ffffff' },
];
...
export default function HeroProductScene() {
    ...
    const items = useMemo(
        () =>
            SHOWCASE.map((entry) => {
                const product = catalog[entry.index];
                return {
                    ...entry,
